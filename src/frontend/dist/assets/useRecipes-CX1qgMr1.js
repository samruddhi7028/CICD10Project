...
import { w as Subscribable, x as shallowEqualObjects, y as hashKey, z as getDefaultState, A as notifyManager, G as useQueryClient, r as reactExports, H as noop, J as shouldThrowError, n as createActor } from "./index-C5v_uq_Z.js";
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return actor.getRecipes(
        (filters == null ? void 0 : filters.search) ?? null,
        (filters == null ? void 0 : filters.category) ?? null,
        (filters == null ? void 0 : filters.dietaryTag) ?? null,
        (filters == null ? void 0 : filters.difficulty) ?? null,
        (filters == null ? void 0 : filters.maxPrepTime) ?? null
      );
    },
...
function useRatings(recipeId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["ratings", recipeId == null ? void 0 : recipeId.toString()],
    queryFn: async () => {
